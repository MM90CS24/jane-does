...
async def start(client: Client, message: Message):
	...
	if comprobacion_de_user(username) == False:
		await send("Hola. Revice en mi lista de usuarios y no te tengo registrado. Contacta a @MM90CS24 para otorgarte el acceso.")
		return
	else:pass
...
##	svmem = psutil.virtual_memory()
	...
	msg = f"✧ Configuracion\n"	    
	msg += "➣Estado de actividad: "+ Configs["s"] +"\n"
	if auto == "y":
		msg += "➣Subida automatica: **On**\n\n"
	else:
		msg += "➣Subida automatica: **Off**\n\n"
...
##        msg += f"➣𝘗𝘦𝘳𝘤𝘦𝘯𝘵𝘢𝘨𝘦: **{sizeof_fmt(svmem.percent)}%**\n\n"
	msg += f"Informacion del disco\n"
	msg += f"➣Total de espacio: **{sizeof_fmt(used)}** / **{sizeof_fmt(total)}**\n"
	msg += f"➣Espacio libre: **{sizeof_fmt(free)}**\n\n"
...
@bot.on_message(filters.command("uyyhg", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("chgkjkg", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("fuufj", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("ueike", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("aejjss", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("wjjdd", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("pwjjd", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("wjjs", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("xwjjd", prefixes="/") & filters.private)
async def nube(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
...
@bot.on_message(filters.command("inwwww", prefixes="/")& filters.private)
async def nube(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
...
@bot.on_message(filters.command("cejdjd", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("zwjjdus", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("siiiiiik", prefixes="/")& filters.private)
async def zips(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
...
@bot.on_message(filters.command("pygyggyuy", prefixes="/")& filters.private)
async def zips(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
...
@bot.on_message(filters.command("osffd", prefixes="/")& filters.private)
async def zips(client: Client, message: Message):
	username = message.from_user.username
	send = message.reply
	try:await get_messages()
...
#borrados
@bot.on_message(filters.command("dssdd", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("defeefs", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("neesd", prefixes="/")& filters.private)
...
@bot.on_message(filters.command("delefsdd", prefixes="/")& filters.private)
...
@bot.on_message(filters.regex("iskas") & filters.private)
...
@bot.on_message(filters.command("chhuuih", prefixes="/") & filters.private)
