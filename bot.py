...
async def tutorial(client: Client, message: Message):
	...
	await bot.send_document(username,caption="Para comenzar enviame un enlace de telegram o link admisible por el bot y a continuacion utiliza el comando up o el nombrado subir archivos para empezar a convertirlo en documento telegram")
